const editor_component = {
    template: `<div class="editor-root" ref="editor_width" :class="{ preview: preview_class !== '' }">
                 ...
                 <div id="texture-field" ref="back_ground" >
                    <div id="word-pad" contenteditable="true" ref="content" spellcheck="false" @click="editor_click_event" @keydown="editor_keydown_event" @keyup="editor_keyup_event"  :class=wordPad_class>
                    <div class="line-content" ref="line_div"></div>
                    </div>
                    <div id="drag_container" ref="drag" @mousedown="start_drag_event" :class="drag_container_class">
                    
                    </div>
                    <div id="imageContainer" ref="image" :class=image_container_class>
